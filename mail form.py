...
miFrame.pack()
Label(raiz, text="\nResultado").pack()
Entry(raiz, justify=CENTER).pack()
raiz.mainloop()
import smtplib
...
login = "f836c4ea30bc62" # paste your login generated by Mailtrap
password = "5f2bfb059db3e9" # paste your password generated by Mailtrap
